                    ...
                    <tbody>
                      ...
                      while($data_row = mysqli_fetch_array($select_result))
                      {
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td>
                                <a name="" id="" class="btn btn-success btn-sm" href="viewpages.php?id=<?php echo $data_row['id']; ?>" role="button">View</a>
                                <a name="" id="" class="btn btn-info btn-sm" href="editpages.php?id=<?php echo $data_row['id']; ?>" role="button">Edit</a>
                                <a name="" id="" class="btn btn-danger btn-sm" href="process/deletepages.php?id=<?php echo $data_row['id']; ?>" role="button">Delete</a>
                            </td>
