        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Pages Info</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active">Edit Pages Info</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($title != "" && $slug != "" && $content != "") {
                                    $update_query = "UPDATE pages SET title='$title', slug='$slug' ,content='$content', status='$status', created_at='$created_at', updated_at='$updated_at' WHERE id=$id";
                            ...
                            ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Pages info is updated successfully.</strong>
                                        </div>
                                    ...
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Pages info couldn't be updated successfully.</strong>
                                        </div>
                                    <?php
                                    }
                                } else {
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Pages info</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
