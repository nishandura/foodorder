                        ...
                        <div class="col-md-12">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($title != "" && $slug != "" && $order_no != "") {
                                    ...
                                    $insert_query = "INSERT INTO menu(title,slug,order_no)VALUES('$title','$slug','$order_no')";
                            ...
                            ?>
                                    ...
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Menu couldn't be added successully.</strong>
                                        </div>
                                <?php
                                    }
                                }
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="slug" class="form-control" id="exampleInputSlug1" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputOrderno1">Order_no</label>
                                                    <input type="number" name="order_no" class="form-control" id="exampleInputOrderno1" placeholder="">
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-6">
                        <div class="form-group">
