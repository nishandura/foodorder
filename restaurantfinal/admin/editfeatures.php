                        ...
                        <div class="col-md-12">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($title != "" && $icon != "" && $order_no != "" && $created_at) {
                                    $update_query = "UPDATE features SET title='$title', icon='$icon' ,order_no='$order_no', status='$status', created_at='$created_at', updated_at='$updated_at' WHERE id=$id";
                            ...
                            ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Features is updated successfully.</strong>
                                        </div>
                                    ...
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Features couldn't be updated successfully.</strong>
                                        </div>
                                    <?php
                                    }
                                } else {
