        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Siteconfig Info</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active">Edit Siteconfig Info</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($sitekey != "" && $sitevalue!= "") {
                                    $update_query = "UPDATE siteconfigs SET sitekey='$sitekey', sitevalue='$sitevalue' , status='$status', created_at='$created_at', updated_at='$updated_at' WHERE id=$id";
                            ...
                            ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Siteconfig info is updated successfully.</strong>
                                        </div>
                                    ...
                                    ?>
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <strong>Siteconfig info couldn't be updated successfully.</strong>
                                        </div>
                                    <?php
                                    }
                                } else {
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit siteconfig info</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="#" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sitekey" value="<?php echo $select_sitekey; ?>" class="form-control" id="exampleInputSitekey1" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Sitevalue</label>
                                            <input type="text" name="sitevalue" value="<?php echo $select_sitevalue; ?>" class="form-control" id="exampleInputSubTitle1" placeholder="">
                                        </div>
                                        <div class="form-group">
