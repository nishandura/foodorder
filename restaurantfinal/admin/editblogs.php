                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($title != "" && $slug != "" && $content != "" && $created_at) {
                                    $update_query = "UPDATE blogs SET title='$title', slug='$slug' ,img='$img', content='$content', status='$status', created_at='$created_at', updated_at='$updated_at' WHERE id=$id";
                                ...
                                <form action="#" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="<?php echo  $select_row['title']; ?>" class="form-control" id="exampleInputTitle1" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Slug</label>
                                            <input type="text" name="slug" value="<?php echo $select_row['slug']; ?>" class="form-control" id="exampleInputSlug1" placeholder="">
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" value="" name="content" id="summernote" rows="15"><?php echo $select_content; ?></textarea>
                                        </div>
                                        <div class="form-group">
