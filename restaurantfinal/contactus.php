...
<body>
    ...
    <section class="firstsectioncontactform">
        <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
            <div class="row gx-lg-5 align-items-center mb-5">
                <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                    <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
                        Contact Us <br />
                        <span style="color: hsl(218, 81%, 75%)">You can fill the form to contact us</span>
                    </h1>
                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                           <?php
                            if(isset($_POST['submit'])){
                                ...
                                $insert_query = "INSERT INTO contactus(name,email,phnno,message) values('$name','$email','$phnno','$message')";
                                $insert_result = mysqli_query($conn,$insert_query);
                                if($insert_result){
                                    echo header('Location: contactus.php');
                                }else{
                                    echo header('Location: contactus.php');
                                }
                           ...
                           ?>
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <!-- Phone Number input -->
                                <div class="form-outline mb-4">
                                    <input type="text" id="" name="phnno"  class="form-control" />
                                    <label class="form-label"  max-length="10" for="">Phone Number</label>
                                   
                                </div>

                                <!-- Message input -->
                                <div class="form-outline mb-4">
                                    <textarea type="text" id="" name="message" class="form-control"></textarea>
    ...
    <!-- end first section contact form-->
